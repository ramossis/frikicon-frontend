...
export declare const DEVTOOLS_MOUNT_PATH = "/__devtools/";
export declare const DEVTOOLS_MOUNT_PATH_NO_TRAILING_SLASH = "/__devtools";
export declare const DEVTOOLS_DIRNAME = "__devtools";
/**
 ...
 */
export declare const DEVTOOLS_WS_ROUTE = "__ws";
export declare const DEVTOOLS_WS_PATH = "/__devtools/__ws";
export declare const DEVTOOLS_DOCK_IMPORTS_VIRTUAL_ID = "/__devtools-client-imports.js";
/**
 ...
 */
export declare const DEVTOOLS_INSPECTOR_DOCK_ID = "devframes_plugin_inspect";
/**
 ...
 */
export declare const DEVTOOLS_TERMINALS_DOCK_ID = "devframes_plugin_terminals";
//#endregion
export { DEFAULT_CATEGORIES_ORDER, DEFAULT_STATE_USER_SETTINGS, DEVTOOLS_CONNECTION_META_FILENAME, DEVTOOLS_DOCK_IMPORTS_FILENAME, DEVTOOLS_RPC_DUMP_DIRNAME, DEVTOOLS_RPC_DUMP_MANIFEST_FILENAME, type DevToolsDocksUserSettings, REMOTE_CONNECTION_KEY };