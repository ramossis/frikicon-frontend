import { C as vModelText, G as createBaseVNode, It as onMounted, Mt as onBeforeUnmount, N as Fragment, Ot as mergeProps, W as computed, Xn as shallowRef, _n as watch, kt as nextTick, or as normalizeClass, qn as ref, tt as createVNode, vn as watchEffect, wn as withDirectives } from "./vue.runtime.esm-bundler-BQrNAWUe.js";
import { A as getActiveElement, G as omit, St as isString, T as filterInputAttrs, _t as isFunction, bt as isNumber, d as propsFactory, m as callEvent, n as genericComponent, v as clamp, y as convertToUnit } from "./defineComponent-DrE4ifQT.js";
...
import { t as Intersect } from "./intersect-DKMMWO87.js";
...
import { n as makeVFieldProps, r as VCounter, t as VField } from "./VField-B7AX_kiV.js";
import { n as makeAutocompleteProps, r as useAutocomplete, t as useAutofocus } from "./autofocus-DnejWvgY.js";
import "/home/ramos/Escritorio/proyecto_frikivon/friki_con/node_modules/vuetify/lib/components/VTextField/VTextField.css";
import "/home/ramos/Escritorio/proyecto_frikivon/friki_con/node_modules/vuetify/lib/components/VTextarea/VTextarea.css";
...
var VTextarea = genericComponent()({
	...
	setup(props, { attrs, emit, slots }) {
		...
		const max = computed(() => {
			...
			if (!props.counter || !isNumber(props.counter) && !isString(props.counter)) return void 0;
		...
		function onFocus() {
			...
			if (textareaRef.value !== getActiveElement()) textareaRef.value?.focus();
		...
		useRender(() => {
			const hasCounter = !!(slots.counter || props.counter !== void 0 || props.counterValue != null);
