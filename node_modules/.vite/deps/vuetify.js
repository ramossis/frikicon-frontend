import { Gn as reactive, Hn as onScopeDispose, Nn as effectScope, St as inject$1, W as computed, _n as watch, kt as nextTick, mt as h, tr as toValue } from "./vue.runtime.esm-bundler-CZzmpwlB.js";
import { H as mergeDeep, I as includes, Tt as isString, a as createDefaults, bt as isFunction, c as useDefaults, ct as consoleWarn, i as RootDefaultsSymbol, k as getActiveElement, kt as range, q as padStart, r as DefaultsSymbol, t as defineComponent, tt as IN_BROWSER, ut as propsFactory, wt as isObject } from "./defineComponent-BW8G7rbF.js";
import { i as useRtl, n as createLocale, r as useLocale, t as LocaleSymbol } from "./locale-CyZVNQlk.js";
import { a as useTheme, n as createTheme, t as ThemeSymbol } from "./theme-D5Vm6Ccl.js";
import { o as VSvgIcon, r as VClassIcon, t as IconSymbol } from "./icons-DGmhKsow.js";
import { a as useDisplay, r as createDisplay, t as DisplaySymbol } from "./display-aFIXZGl3.js";
import { n as createGoTo, r as useGoTo, t as GoToSymbol } from "./goto-D3X5yv1j.js";
import { i as useLayout } from "./layout-DV2otR9N.js";
import { n as createRules, r as useRules, t as RulesSymbol } from "./rules-MUNWbEgD.js";
...
function createInstance(options, locale) {
	const instance = reactive(isFunction(options.adapter) ? new options.adapter({
...
function parseKeyCombination(input) {
	...
	function parseKey() {
		const ch = peek();
		if (!isString(ch)) throw new ParseError("Unexpected end of input");
		const next = peek(1);
		if (isSep(ch) && isString(next) && !isSep(next)) throw new ParseError(`Unexpected separator '${ch}' at position ${pos}`);
		const first = consume();
...
function matchesKeyGroup(e, group, isMac) {
	if (!isString(group) && group.type === "alternate") return group.parts.some((part) => matchesKeyGroup(e, part, isMac));
...
//#endregion
//#region node_modules/vuetify/lib/composables/rules/plugin.js
...
//#endregion
export { createRulesPlugin, createVuetify, useDate, useDefaults, useDisplay, useGoTo, useHotkey, useLayout, useLocale, useMask, useRtl, useRules, useTheme, version };
