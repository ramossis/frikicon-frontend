import { $n as toRef, At as onActivated, Gn as reactive, Hn as onScopeDispose, It as onMounted, Mt as onBeforeUnmount, Pt as onDeactivated, St as inject, W as computed, Wt as provide, Xn as shallowRef, _n as watch, ln as useId, qn as ref } from "./vue.runtime.esm-bundler-CZzmpwlB.js";
import { R as isPercentage, T as findChildrenWithProvide, Z as resolveSize, ct as consoleWarn, l as getCurrentInstance, ut as propsFactory, v as convertToUnit } from "./defineComponent-BW8G7rbF.js";
...
var generateLayers = (layout, positions, layoutSizes, activeItems, sizeOf) => {
	let previousLayer = {
		top: 0,
		left: 0,
		right: 0,
		...
		register: (vm, { id, order, position, layoutSize, elementSize, active, disableTransitions, absolute }) => {
			...
			return {
				layoutItemStyles: computed(() => {
					...
					return {
						...styles,
						height: isHorizontal ? `calc(100% - ${item.top}px - ${item.bottom}px)` : measuredSize ? convertToUnit(measuredSize) : void 0,
						left: isOppositeHorizontal ? void 0 : `${item.left}px`,
						right: isOppositeHorizontal ? `${item.right}px` : void 0,
						top: position.value !== "bottom" ? `${item.top}px` : void 0,
						bottom: position.value !== "top" ? `${item.bottom}px` : void 0,
						width: !isHorizontal ? `calc(100% - ${item.left}px - ${item.right}px)` : measuredSize ? convertToUnit(measuredSize) : void 0
					};
				}),
