import { $n as toRef, Gn as reactive, Hn as onScopeDispose, Qt as resolveDynamicComponent, W as computed, kt as nextTick } from "./vue.runtime.esm-bundler-CZzmpwlB.js";
import { P as hasEvent, Tt as isString, l as getCurrentInstance, tt as IN_BROWSER, ut as propsFactory } from "./defineComponent-BW8G7rbF.js";
...
function useLink(props, attrs) {
	...
	const isActive = computed(() => {
		...
		if (route.value && route.value.matched.length === 0 && route.value.name == null) return link.value.isExactActive?.value ?? false;
