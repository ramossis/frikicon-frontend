import { $n as toRef, G as createBaseVNode, W as computed, cr as normalizeStyle, or as normalizeClass, qn as ref, tt as createVNode, vn as watchEffect } from "./vue.runtime.esm-bundler-CZzmpwlB.js";
import { _ as clamp, n as genericComponent, rt as PREFERS_REDUCED_MOTION, ut as propsFactory, v as convertToUnit, wt as isObject } from "./defineComponent-BW8G7rbF.js";
import { n as makeComponentProps, t as useRender } from "./useRender-BeL2a1eu.js";
import { t as makeTagProps } from "./tag-BSglvz7l.js";
import { r as useTextColor } from "./color-BOsIBON5.js";
...
import { n as useSize, t as makeSizeProps } from "./size-SO05V6lj.js";
import { n as useReveal, r as useIntersectionObserver, t as makeRevealProps } from "./reveal-DYhRh4yO.js";
import "/home/ramos/Escritorio/proyecto_frikivon/friki_con/node_modules/vuetify/lib/components/VProgressCircular/VProgressCircular.css";
...
var VProgressCircular = genericComponent()({
	...
	setup(props, { slots }) {
		...
		const transitionDuration = toRef(() => props.transition === false ? void 0 : convertToUnit(isObject(props.transition) ? props.transition.duration : void 0, "ms"));
		const size = toRef(() => {
