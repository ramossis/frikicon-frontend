import { $n as toRef, Hn as onScopeDispose, Pn as getCurrentScope, St as inject, W as computed, Wt as provide, Xn as shallowRef, _n as watch, qn as ref, vn as watchEffect } from "./vue.runtime.esm-bundler-CZzmpwlB.js";
import { Ct as isNumber, H as mergeDeep, Tt as isString, at as SUPPORTS_MATCH_MEDIA, ct as consoleWarn, kt as range, l as getCurrentInstance, lt as deprecate, rt as PREFERS_REDUCED_MOTION, tt as IN_BROWSER, ut as propsFactory, wt as isObject, yt as isElement } from "./defineComponent-BW8G7rbF.js";
import { t as Box } from "./box-7BtZMpWz.js";
import { c as parseColor, i as hasLightForeground, n as darken, r as getLuma, s as lighten, t as RGBtoHex } from "./colorUtils-BFKd_7kF.js";
...
function genCssVariables(theme, prefix) {
	...
	for (const [key, value] of Object.entries(theme.variables)) {
		const color = isString(value) && value.startsWith("#") ? parseColor(value) : void 0;
		const rgb = color ? `${color.r}, ${color.g}, ${color.b}` + (isNumber(color.a) ? `, ${color.a}` : "") : void 0;
...
function genVariation(name, color, variations) {
	...
	if (variations) for (const variation of ["lighten", "darken"]) {
		...
		for (const amount of range(variations[variation], 1)) object[`${name}-${variation}-${amount}`] = RGBtoHex(fn(parseColor(color), amount));
	}
	return object;
}
