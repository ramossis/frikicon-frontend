import { $n as toRef, Gn as reactive, Hn as onScopeDispose, St as inject, W as computed, Xn as shallowRef, er as toRefs, vn as watchEffect } from "./vue.runtime.esm-bundler-CZzmpwlB.js";
import { Ct as isNumber, H as mergeDeep, ot as SUPPORTS_TOUCH, tt as IN_BROWSER, u as getCurrentInstanceName, ut as propsFactory, wt as isObject, xt as isNull } from "./defineComponent-BW8G7rbF.js";
...
function useDisplay(props = { mobile: null }, name = getCurrentInstanceName()) {
	...
	const mobile = computed(() => {
		...
		else if (isNumber(props.mobileBreakpoint)) return display.width.value < props.mobileBreakpoint;
		else if (props.mobileBreakpoint) return display.width.value < display.thresholds.value[props.mobileBreakpoint];
		else if (isNull(props.mobile)) return display.mobile.value;
		else return false;
	});
