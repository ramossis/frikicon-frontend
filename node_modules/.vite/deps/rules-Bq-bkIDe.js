import { $n as toRef, St as inject, W as computed } from "./vue.runtime.esm-bundler-BQrNAWUe.js";
import { St as isString } from "./defineComponent-DrE4ifQT.js";
...
function createRules(options, locale) {
	...
	function resolve(fn) {
		return computed(() => fn().map((rule) => {
			...
			} else if (isString(rule)) ruleName = rule;
			if (ruleName) {
...
//#endregion
export { createRules as n, useRules as r, RulesSymbol as t };
