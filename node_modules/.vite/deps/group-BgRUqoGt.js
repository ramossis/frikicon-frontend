import { $n as toRef, Gn as reactive, It as onMounted, Mt as onBeforeUnmount, St as inject, Vt as onUpdated, W as computed, Wt as provide, _n as watch, ln as useId, rr as unref } from "./vue.runtime.esm-bundler-BQrNAWUe.js";
import { E as findChildrenWithProvide, Mt as consoleWarn, bt as isNumber, d as propsFactory, l as getCurrentInstance, tt as wrapInArray, vt as isNull, wt as isUndefined } from "./defineComponent-DrE4ifQT.js";
...
function useGroup(props, injectKey) {
	...
	function register(item, vm) {
		...
		const index = findChildrenWithProvide(key, groupVm?.vnode).indexOf(vm);
...
function getIds(items, modelValue) {
	...
	modelValue.forEach((value) => {
		...
		if (!isUndefined(item?.value)) ids.push(item.id);
