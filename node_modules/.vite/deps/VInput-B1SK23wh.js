import { $n as toRef, G as createBaseVNode, It as onMounted, Mt as onBeforeUnmount, Ot as mergeProps, W as computed, Xn as shallowRef, _n as watch, cr as normalizeStyle, jt as onBeforeMount, kt as nextTick, ln as useId, or as normalizeClass, qn as ref, rr as unref, tt as createVNode } from "./vue.runtime.esm-bundler-BQrNAWUe.js";
import { St as isString, Y as pick, _t as isFunction, d as propsFactory, l as getCurrentInstance, m as callEvent, n as genericComponent, p as EventProp, tt as wrapInArray, u as getCurrentInstanceName, wt as isUndefined } from "./defineComponent-DrE4ifQT.js";
import { g as VSlideYTransition } from "./transitions-BvVY0ByH.js";
import { n as makeComponentProps, t as useRender } from "./useRender-0m5V27n9.js";
import { r as useTextColor } from "./color-DqNjESwS.js";
...
import { i as useRtl, r as useLocale } from "./locale-B1heYDOd.js";
import { r as useRules } from "./rules-Bq-bkIDe.js";
...
import "/home/ramos/Escritorio/proyecto_frikivon/friki_con/node_modules/vuetify/lib/components/VInput/VInput.css";
import "/home/ramos/Escritorio/proyecto_frikivon/friki_con/node_modules/vuetify/lib/components/VMessages/VMessages.css";
...
function useValidation(props, name = getCurrentInstanceName(), id = useId()) {
	...
	async function validate(silent = false) {
		...
		for (const rule of rules.value) {
			...
			const result = await (isFunction(rule) ? rule : () => rule)(validationModel.value);
	...
	setup(props, { attrs, slots, emit }) {
		...
		useRender(() => {
			...
			return createBaseVNode("div", {
				...
				props.hideDetails !== true && createBaseVNode("div", {
					"id": messagesId.value,
					"class": normalizeClass(["v-input__details", { "v-input__details--hidden": !hasDetails.value }]),
					"role": "alert",
					"aria-live": "polite"
