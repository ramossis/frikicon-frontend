...
function resolveModifier(modifier) {
	...
	if (modifier) {
		if (modifier.startsWith("[") && modifier.endsWith("]")) interpolationMethod = modifier.slice(1, -1);
...
function getSizeValue(theme, hw, prop) {
	...
	if (!v) switch (prop) {
		...
		case "stretch":
			v = "stretch";
			break;
		case "screen": v = hw === "w" ? "100vw" : "100vh";
	}
