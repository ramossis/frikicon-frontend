...
@layer vuetify-final.trumps {
  ...
  .v-btn-group--has-size .v-btn--icon.v-btn--density-default {
    width: calc(var(--v-btn-height) + 0px);
    height: calc(var(--v-btn-height) + 0px);
  }
  .v-btn-group--has-size .v-btn--icon.v-btn--density-comfortable {
    width: calc(var(--v-btn-height) + -8px);
    height: calc(var(--v-btn-height) + -8px);
  }
  .v-btn-group--has-size .v-btn--icon.v-btn--density-compact {
    width: calc(var(--v-btn-height) + -12px);
    height: calc(var(--v-btn-height) + -12px);
  }
  .v-btn-group--density-default.v-btn-group--horizontal:not(.v-btn-group--has-size) {
    height: 48px;
  }
  .v-btn-group--density-comfortable.v-btn-group--horizontal:not(.v-btn-group--has-size) {
    height: 40px;
  }
  .v-btn-group--density-compact.v-btn-group--horizontal:not(.v-btn-group--has-size) {
    height: 36px;
  }
...
@layer vuetify-components {
  ...
  .v-locale--is-rtl.v-date-input input, .v-locale--is-rtl .v-date-input input {
    text-align: right;
  }
  .v-date-input__format-hint {
    align-items: center;
    direction: ltr;
    display: flex;
    inset: 0;
  ...
  .v-locale--is-rtl.v-date-input__format-hint, .v-locale--is-rtl .v-date-input__format-hint {
    justify-content: flex-end;
  }
  .v-date-input__format-hint > span {
    opacity: 0;
  }
}@layer vuetify-components {
  .v-counter {
  ...
  .v-date-picker-month__day--range-start > .v-date-picker-month__range-bg {
    ...
    border-start-start-radius: var(--range-selection-rounding);
    border-end-start-radius: var(--range-selection-rounding);
  }
  .v-date-picker-month__day--range-end > .v-date-picker-month__range-bg {
    inset-inline-end: 2px;
    border-start-end-radius: var(--range-selection-rounding);
    border-end-end-radius: var(--range-selection-rounding);
  }
...
@layer vuetify-components {
  ...
  .v-file-input--dragging .v-field {
    outline-color: rgba(var(--v-theme-on-surface), var(--v-medium-emphasis-opacity));
  }
  .v-file-input--dragging input[type=file] {
    z-index: 1;
  }
  .v-file-input input[inert] {
    pointer-events: none;
  }
}@layer vuetify-components {
  ...
  .v-file-upload-dropzone--dragging.v-sheet {
...
@layer vuetify-components {
  ...
  .v-input__details {
    ...
    transition: height 150ms cubic-bezier(0.4, 0, 0.2, 1), min-height 150ms cubic-bezier(0.4, 0, 0.2, 1), padding-top 150ms cubic-bezier(0.4, 0, 0.2, 1), opacity 150ms cubic-bezier(0.4, 0, 0.2, 1), visibility 150ms cubic-bezier(0.4, 0, 0.2, 1);
  }
  @media (prefers-reduced-motion: reduce) {
    .v-input__details {
...
@layer vuetify-final.trumps {
  ...
  .v-list--navigable .v-list-item::after,
  .v-list--navigable .v-list-item__overlay {
    transition: none;
  }
  .v-list {
    --indent-padding: 0px;
...
@layer vuetify-components {
  .v-progress-linear {
    --v-progress-linear-transition-duration: 0.2s;
    background: transparent;
    overflow: hidden;
    position: relative;
    transition: var(--v-progress-linear-transition-duration) cubic-bezier(0.4, 0, 0.2, 1), mask-size 0s;
    width: 100%;
  }
  ...
  .v-progress-linear__buffer {
    ...
    top: 0;
    width: 100%;
    transition: width var(--v-progress-linear-transition-duration) cubic-bezier(0.4, 0, 0.2, 1), left var(--v-progress-linear-transition-duration) cubic-bezier(0.4, 0, 0.2, 1), right var(--v-progress-linear-transition-duration) cubic-bezier(0.4, 0, 0.2, 1);
  }
}
@layer vuetify-final.trumps {
  @media (forced-colors: active) {
...
@layer vuetify-components {
  ...
  .v-progress-linear--revealing {
    --v-progress-reveal-duration: 900ms;
  }
  .v-progress-linear--revealing .v-progress-linear__determinate {
    transition-duration: var(--v-progress-reveal-duration);
  }
  .v-progress-linear--no-transition {
    --v-progress-linear-transition-duration: 0s;
  }
  ...
  .v-progress-circular {
    --v-progress-circular-transition-duration: 0.2s;
    align-items: center;
    display: inline-flex;
    justify-content: center;
    overflow: hidden;
  ...
  .v-progress-circular__overlay {
    stroke: currentColor;
    transition: all var(--v-progress-circular-transition-duration) ease-in-out, stroke-width 0s;
    z-index: 2;
  }
  ...
  .v-progress-circular--revealing .v-progress-circular__overlay {
    transition-duration: var(--v-progress-reveal-duration), 0s;
  }
  .v-progress-circular--no-transition {
    --v-progress-circular-transition-duration: 0s;
  }
  ...
  .v-progress-circular--indeterminate > svg {
    ...
    transition: all var(--v-progress-circular-transition-duration) ease-in-out;
  }
...
.v-pull-to-refresh__scroll-container--touching {
  ...
  .v-slide-group--snap .v-slide-group__container {
    scroll-snap-type: x mandatory;
  }
  .v-slide-group--snap .v-slide-group__content > * {
    scroll-snap-align: var(--v-slide-group-snap-align, start);
  }
  .v-slide-group--snap.v-slide-group--vertical .v-slide-group__container {
  ...
  .v-skeleton-loader__chip-group {
    flex-wrap: wrap;
    padding: 16px;
    gap: 12px;
  }
  .v-skeleton-loader__chip-group > .v-skeleton-loader__chip {
    flex: 0 0 auto;
    margin: 0;
  }
  .v-skeleton-loader__chip-group > .v-skeleton-loader__chip:nth-child(5n+1) {
    min-width: 60px;
  }
  .v-skeleton-loader__chip-group > .v-skeleton-loader__chip:nth-child(5n+2) {
    min-width: 160px;
  }
  .v-skeleton-loader__chip-group > .v-skeleton-loader__chip:nth-child(5n+3) {
    min-width: 85px;
  }
  .v-skeleton-loader__chip-group > .v-skeleton-loader__chip:nth-child(5n+4) {
    min-width: 55px;
  }
  .v-skeleton-loader__chip-group > .v-skeleton-loader__chip:nth-child(5n+5) {
    min-width: 110px;
  }
  ...
  .v-skeleton-loader__table-tfoot > .v-skeleton-loader__text.v-skeleton-loader__bone:nth-child(1) {
    max-width: 170px;
  }
  .v-skeleton-loader__table-tfoot > .v-skeleton-loader__text.v-skeleton-loader__bone:nth-child(2) {
    max-width: 64px;
  }
