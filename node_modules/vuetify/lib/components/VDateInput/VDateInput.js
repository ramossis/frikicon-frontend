import { Fragment as _Fragment, createElementVNode as _createElementVNode, mergeProps as _mergeProps, createVNode as _createVNode } from "vue";
// Styles
...
import { closeWhenFocusLeaves, useOpenOnFocus } from "../../composables/openOnFocus.js";
import { useProxiedModel } from "../../composables/proxiedModel.js";
import { createSegmentedEdit } from "../../composables/segmentedMask/index.js"; // Utilities
import { computed, ref, shallowRef, watch } from 'vue';
import { genericComponent, isFunction, omit, pick, propsFactory, useRender, wrapInArray } from "../../util/index.js"; // Types
// Types
  ...
  setup(props, {
    ...
    useRender(() => {
      ...
      return _createVNode(VTextField, _mergeProps({
        ...
        ...slots,
        default: () => _createElementVNode(_Fragment, null, [isFocused.value && !isReadonly.value && !!text.value && _createElementVNode("div", {
        ...
        }, [text.value]), formatHint.value]), _createVNode(VMenu, _mergeProps({
          "ref": vMenuRef,
