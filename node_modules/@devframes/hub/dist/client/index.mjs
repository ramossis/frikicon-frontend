...
function watchFrameLocation(options) {
	...
	*/
	...
	function subscribe() {
		...
		detach = () => {
			for (const unsubscribe of listeners) try {
				unsubscribe();
			} catch {}
		};
	}
