 ...
 * assets).
 */
export declare function devframeVitePlugin(d: DevframeDefinition, options?: DevframeVitePluginOptions): DevframeVitePlugin;
 ...
 * `dev` / `build` / `mcp` shell.
 */
export declare function devframeViteBridge(d: DevframeDefinition, options?: DevframeViteBridgeOptions): DevframeVitePlugin;
 ...
 * bundled UI).
 */
export declare function devframeVite(d: DevframeDefinition, options?: DevframeViteOptions): DevframeVitePlugin;
//#endregion