...
function createRpcSharedStateServerHost(rpc) {
	...
	rpc.register({
		...
		handler: async (key, value, syncId) => {
			(await host.get(key, { initialValue: value })).patch([{
				op: "replace",
				path: [],
				value
			}], syncId);
